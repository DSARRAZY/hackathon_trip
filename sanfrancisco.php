...
<html>
    ...
    <body>
    <header class="header">
            <div class="header-logo"><a class="link" href='tokyo.php'><svg id="logo" width="41" height="22" viewBox="0 0 41 22" fill="none">
        ...
        <section class="site-hero overlay">
            <div class="container">
                <div class="row site-hero-inner justify-content-center align-items-center">
                    <div class="col-md-10 text-center">
                        <h1 class="heading" data-aos="fade-up">Welcome to <em>San Francisco</em></h1>
                        <div style="text-align:center;padding:1em 0;"> <h2><a style="text-decoration:none;" href="https://www.zeitverschiebung.net/fr/city/5391959"></h2> <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=fr&size=large&timezone=America%2FLos_Angeles" width="100%" height="140" frameborder="0" seamless></iframe> </div>
                    </div>
                </div>
            </div>
        </section>
          ...
          <div class="row justify-content-center">
              <div class="col-4">
                  <div class="card text-warning" style="width: 18rem;text-lighttext-light">
                ...
                <div class="col-4">
                  <div class="card text-dark" style="width: 18rem;">
                      <div class="card-body text-sm-center">
                          ...
                          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100939.98568959434!2d-122.50781196836382!3d37.757814895024374!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan%20Francisco%2C%20Californie%2C%20%C3%89tats-Unis!5e0!3m2!1sfr!2sfr!4v1588178158091!5m2!1sfr!2sfr" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                      </div>
                  </div>
                </div>
                    <div class="col-4">
                        <div class="card text-dark" style="width: 18rem;">
                            <div class="card-body text-sm-center">
                                ...
                                <a name="windy-webcam-timelapse-player" data-id="1251810730" data-play="day" href="https://windy.com/webcams/1251810730" target="_blank">San Francisco: Potrero Hill</a><script async type="text/javascript" src="https://webcams.windy.com/webcams/public/embed/script/player.js"></script>
                            </div>
                        </div>
                    </div>
                <div class="col-4">
                    <div class="card text-dark" style="width: 18rem;">
                        <div class="card-body text-sm-center">
                            ...
                            <iframe width="650" height="450" src="https://embed.windy.com/embed2.html?lat=37.281&lon=-122.423&zoom=8&level=surface&overlay=wind&menu=&message=&marker=&calendar=&pressure=&type=map&location=coordinates&detail=&detailLat=37.281&detailLon=-122.423&metricWind=default&metricTemp=default&radarRange=-1" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
            </div>
        <div class="row justify-content-left">
            <div class="col-4">
                <div class="card text-dark" style="width: 18rem;">
                    <div class="card-body text-sm-center">
                        <h5 class="card-title">Prochain match TV NBA</h5>
                        <h6 class="card-subtitle mb-2 text-muted">vous pouvez selectionner une rencontre</h6>
                        <a class="tvsports-widget" href="https://tv-sports.fr" data-competition-id="149" data-direct-only="0" data-width="100%" data-height="350px">Programme TV NBA</a><script async type="text/javascript" src="https://tv-sports.fr/widget.js"></script>
                    </div>
                </div>
            </div>
        </div>
      ...
      <script src="../js/sanfrancisco.js"></script>
